            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <div
                    style={{
                        ...
                        height: 8,
                        borderRadius: '50%',
                        background: isPlaying ? '#27c93f' : '#333',
                ...
                <span
                    ...
                    style={{
                        fontSize: '11px',
                        color: isPlaying ? '#27c93f' : '#333',
                        fontFamily: "'JetBrains Mono', monospace",
                        cursor: 'pointer',
                        userSelect: 'none',
                    }}
                    onMouseEnter={(e) => {
                        e.currentTarget.style.color = isPlaying ? '#4ade80' : '#555';
                    }}
                    onMouseLeave={(e) => {
                        e.currentTarget.style.color = isPlaying ? '#27c93f' : '#333';
                    }}
                >
                    {bpm} BPM
                </span>
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    {isDirty && (
                        <span
                            style={{ color: 'var(--accent)', fontSize: '16px', marginLeft: '4px' }}
                        >
                            *
                        </span>
                    )}
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <div style={{ position: 'relative' }}>
                    <button
                        ...
                        onMouseEnter={(e) => {
                            if (!themeOpen) e.currentTarget.style.color = '#aaa';
                        }}
                        onMouseLeave={(e) => {
                            if (!themeOpen) e.currentTarget.style.color = '#555';
                        }}
                    >
                        <Palette size={15} />
                    </button>
                ...
                <button
                    ...
                    onMouseEnter={(e) => {
                        if (!hydraOpen) e.currentTarget.style.color = '#aaa';
                    }}
                    onMouseLeave={(e) => {
                        if (!hydraOpen) e.currentTarget.style.color = '#555';
                    }}
                >
                    <Layers size={15} />
                </button>
